...
import vg from "../assets/picture-2.webp"
    ...
    return (
     <>
        <div className='home' id='home'>
            <section>
                <h1>TechStack</h1>
                <p>We Provide Modern Solution for Modern Problem</p>
            </section>
       ...
       <div>
        <p>
            We are one of the best solution provider to the tech problems you face everyday. We are leading
            tech company whose aim is to increase the problem solving ability in  every tech enthusiast.
        </p>
       </div>
        </div>
